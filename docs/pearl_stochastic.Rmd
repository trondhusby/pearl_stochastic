...
De ontwikkeling van de (totale) risikobevolking in de vier groote gemeenten is te zien in Figuur \@ref(fig:results-regional). De zwarte lijnen in het figuur is de gemiddelde voorspelling en het grijz gebied om de lijn 80 procent onzekerheidsmarges. Aan de linkerkant in de figuur heeft woningbouw geen invloed op vestiging ($gamma_{w} = 0$); hier zien we dat de bevolkingsontwikkeling bijna volledig wordt gedreven door verandering in het migratiesaldo. Hierdoor zijn de onzekerheidsmarges ook relatief klein. De bandbeedtes worden groter als we woningbouw ook laten varieren.
...
De resultaten hier suggereren dat de meeste variatie in netto migratie en risikobevolking kwam door variatie verandering in nieuwbouwwoningen. Dit is een gevolg van het feit dat nieuwbouwwoningen een directe invloed heeft op de vestigingskans. In PEARL, waar woningbouw een ander rol heeft, is de relatieve invloed van die twee factoren anders.
